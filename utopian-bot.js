...
conn.once('open', function ()
{
  ...
  const category_max_votes=[{"cat":"development","max_vote":300},{"cat":"bug-hunting","max_vote":200},{"cat":"ideas","max_vote":200},{"cat":"translations","max_vote":100},{"cat":"others","max_vote":200}];
  var processed_posts=[];
  const query = {
    reviewed: true,
